...
def buildParser():
    ...
    parser.add_argument("--" + constants.REFRESH_FREQUENCY_OPTION, type=int, default=5, help="the refresh frequency (default=1)")
    ...
    parser.add_argument("--" + constants.DEBUG_OPTION, action="store_false", help="activate the debug mode (default=True)")
    return parser
